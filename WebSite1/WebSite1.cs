...
namespace WebSite1
{
    ...
    /// </summary>
    internal sealed class WebSite1 : StatefulService
    {
        ...
        public WebSite1(StatefulServiceContext context)
            : base(context)
        { }
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            return new ServiceReplicaListener[]
            {
                new ServiceReplicaListener(serviceContext =>
                    ...
                    {
                        ServiceEventSource.Current.ServiceMessage(serviceContext, $"WebSite1 Starting Kestrel on {url}");
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            ServiceEventSource.Current.ServiceMessage(this.Context, "WebSite1 Checking for cached records");
            using (var tx = this.StateManager.CreateTransaction())
            {
                ...
                {
                    ServiceEventSource.Current.ServiceMessage(this.Context, "WebSite1 Cache is up-to-date, {0} words loaded", currentWebModel.Value.WordCount);
                } else
                {
                    ServiceEventSource.Current.ServiceMessage(this.Context, "WebSite1 Begin caching records");
                    ...
                    for (int i = 0; i < ENTRIES_TO_CACHE; i++)
                    {
                        ...
                        ServiceEventSource.Current.ServiceMessage(this.Context, "WebSite1 Adding cache entry Value: {0}", i);
                    }
                    ...
                    ServiceEventSource.Current.ServiceMessage(this.Context, "WebSite1 COMPLETED Caching Records");
                }
